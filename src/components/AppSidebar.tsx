  ...
  return <div className="h-screen w-[280px] fixed left-0 top-0 z-40 flex flex-col bg-card/95 backdrop-blur-sm border-r border-border/50 shadow-lg">
      ...
      <div className="flex-1 overflow-y-auto py-6 px-4 space-y-6">
        ...
        {(hasPermission('templates') || hasPermission('rosters') || hasPermission('birds-view') || hasPermission('timesheet-view')) && <div className="space-y-2">
            ...
            {hasPermission('templates') && <NavigationItem
                to="/templates"
                icon={Workflow}
            ...
            {hasPermission('rosters') && <NavigationItem
                to="/rosters"
            ...
            {hasPermission('birds-view') && <NavigationItem
                to="/birds-view"
                icon={PanelLeft}
                iconColor={iconColorMap.birdsView}
                label="Birds View"
            ...
            {hasPermission('timesheet-view') && <NavigationItem
                to="/timesheet"
                icon={Clock}
        ...
        {/* Additional Features */}
        <div className="space-y-2">
          {hasPermission('broadcast') && <NavigationItem
              to="/broadcast"
              icon={BellRing}
          ...
          {hasPermission('insights') && <NavigationItem
              to="/insights"
              icon={TrendingUp}
          ...
          {hasPermission('configurations') && <NavigationItem
              to="/configurations"
              icon={Settings}
